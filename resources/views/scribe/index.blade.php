                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-products--id-">GET api/products/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products-search--keyword-">
                                <a href="#endpoints-GETapi-products-search--keyword-">GET api/products/search/{keyword}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-products-categories">GET api/products/categories</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products-categories--category-">
                                <a href="#endpoints-GETapi-products-categories--category-">GET api/products/categories/{category}</a>
                            </li>
...
<p>The ID of the product.</p>
                    ...
                    <h2 id="endpoints-GETapi-products-search--keyword-">GET api/products/search/{keyword}</h2>
...
<span id="example-requests-GETapi-products-search--keyword-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products/search/molestiae" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/products/search/molestiae"
);
...
<span id="example-responses-GETapi-products-search--keyword-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-products-search--keyword-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products-search--keyword-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products-search--keyword-"></code></pre>
</span>
<span id="execution-error-GETapi-products-search--keyword-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products-search--keyword-"></code></pre>
</span>
<form id="form-GETapi-products-search--keyword-" data-method="GET"
      data-path="api/products/search/{keyword}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products-search--keyword-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products-search--keyword-"
                    onclick="tryItOut('GETapi-products-search--keyword-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products-search--keyword-"
                    onclick="cancelTryOut('GETapi-products-search--keyword-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products-search--keyword-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/search/{keyword}</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
                <b><code>keyword</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text"
               name="keyword"
               data-endpoint="GETapi-products-search--keyword-"
               value="molestiae"
               data-component="url" hidden>
    <br>
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <b><code>api/products/categories</code></b>
                    ...
                    <h2 id="endpoints-GETapi-products-categories--category-">GET api/products/categories/{category}</h2>
...
<span id="example-requests-GETapi-products-categories--category-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products/categories/ipsa" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/products/categories/ipsa"
);
...
<span id="example-responses-GETapi-products-categories--category-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-products-categories--category-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products-categories--category-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products-categories--category-"></code></pre>
</span>
<span id="execution-error-GETapi-products-categories--category-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products-categories--category-"></code></pre>
</span>
<form id="form-GETapi-products-categories--category-" data-method="GET"
      data-path="api/products/categories/{category}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}'
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products-categories--category-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products-categories--category-"
                    onclick="tryItOut('GETapi-products-categories--category-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products-categories--category-"
                    onclick="cancelTryOut('GETapi-products-categories--category-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products-categories--category-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/categories/{category}</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text"
               name="category"
               data-endpoint="GETapi-products-categories--category-"
               value="ipsa"
               data-component="url" hidden>
    <br>
<p>The category.</p>
